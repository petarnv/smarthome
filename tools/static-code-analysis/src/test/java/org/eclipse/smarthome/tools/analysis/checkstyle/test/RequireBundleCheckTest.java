...
import org.eclipse.smarthome.tools.analysis.checkstyle.RequireBundleCheck;
 ...
 *
 */
public class RequireBundleCheckTest extends BaseCheckTestSupport {
    ...
    public void testManifestFileThatExportsInternalPackage() {
        DefaultConfiguration config = createCheckConfig(RequireBundleCheck.class);
        String testFileName = "REQUIRE_BUNDLE_MANIFEST.MF";
        int lineNumber = 9;

        String[] expectedMessages = { lineNumber + ": " + RequireBundleCheck.MSG_KEY };
